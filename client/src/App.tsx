...
import PropertyChargesPage from "@/pages/PropertyChargesPage";
...
function Router() {
  return (
    <Switch>
      ...
      {/* Property charges are admin-only */}
      <AdminRoute path="/property-charges" component={PropertyChargesPage} />
